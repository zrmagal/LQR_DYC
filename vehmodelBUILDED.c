 ...
 *
  ...
  *  ------------------------------------------------------------------------- 
* Created: Fri Oct 12 11:18:00 2018
*/
#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME vehmodelBUILDED
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
/* %%%-SFUNWIZ_defines_Changes_BEGIN --- EDIT HERE TO _END */
#define NUM_INPUTS          2
/* Input Port  0 */
#define IN_PORT_0_NAME      inSteer
...
/* Output Port  2 */
#define OUT_PORT_2_NAME      outSlip
...
/* Output Port  3 */
#define OUT_PORT_3_NAME      outStates
#define OUTPUT_3_WIDTH       5
...
/* Output Port  4 */
#define OUT_PORT_4_NAME      outDStates
#define OUTPUT_4_WIDTH       5
...
{
    const real_T   *inSteer  = (const real_T*) ssGetInputPortSignal(S,0);
    const real_T   *inMz  = (const real_T*) ssGetInputPortSignal(S,1);
    real_T        *outFz  = (real_T *)ssGetOutputPortRealSignal(S,0);
    real_T        *outFy  = (real_T *)ssGetOutputPortRealSignal(S,1);
    real_T        *outSlip  = (real_T *)ssGetOutputPortRealSignal(S,2);
    real_T        *outStates  = (real_T *)ssGetOutputPortRealSignal(S,3);
    real_T        *outDStates  = (real_T *)ssGetOutputPortRealSignal(S,4);
    const real_T   *xD = ssGetDiscStates(S);
    const real_T   *xC = ssGetContStates(S);
    const int_T   p_width0  = mxGetNumberOfElements(PARAM_DEF0(S));
    const real_T  *params  = (const real_T *)mxGetData(PARAM_DEF0(S));


    vehmodelBUILDED_Outputs_wrapper(inSteer, inMz, outFz, outFy, outSlip, outStates, outDStates, xD,  xC, params , p_width0);
...
/* Function: mdlUpdate ======================================================
  ...
  static void mdlUpdate(SimStruct *S, int_T tid)
  {
    ...
    vehmodelBUILDED_Update_wrapper(inSteer, inMz, outFz, outFy, outSlip, outStates, outDStates,  xD, params, p_width0);
}
...
/* Function: mdlDerivatives =================================================
  ...
  static void mdlDerivatives(SimStruct *S)
  {
    ...
    vehmodelBUILDED_Derivatives_wrapper(inSteer, inMz, outFz, outFy, outSlip, outStates, outDStates,dx,  xC, params, p_width0);
}
